...
const GitHubStats: React.FC = () => {
  ...
  return (
    <section id="github-stats" className="py-20 border-b border-gray-200">
      <div className="w-full max-w-6xl mx-auto px-4">
        ...
        <div className="w-full">
          <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="bg-white rounded-xl p-6 shadow-inner border border-gray-50">
              <img
                src={`https://ghchart.rshah.org/${username}`}
                alt="GitHub Contribution Calendar"
                className="w-full h-auto rounded-lg transform hover:scale-105 transition-transform duration-300"
                loading="lazy"
                style={{ minHeight: '200px', filter: 'drop-shadow(0 4px 6px rgba(0, 0, 0, 0.1))' }}
              />
            </div>
